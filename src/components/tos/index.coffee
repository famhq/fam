...
module.exports = class Tos
  ...
  render: =>
    z '.z-tos',
      z 'p',
        '''
        The following terms and conditions govern all use of the Fam app and all content, services and products available at or through the app. The app is owned and operated by Fam.
        ...
        @router?.link z 'a',
          ...
          'Fam\'s Privacy Policy'
        '''
        ) and procedures that may be published from time to'
        time on this Site by Fam (collectively, the "Agreement").
        '''
      z 'p',
        '''
        ...
        If these terms and conditions are considered an offer by Fam, acceptance is expressly limited to these terms. The app is available only to individuals who
        are at least 13 years old.
        '''
      z 'ol',
        z 'li',
          z 'div.is-bold', 'Your Fam Account and Site.'
          '''
          If you create an account on the app, you are responsible for maintaining the accuracy and security of your account,
          and you are fully responsible for all activities that occur under the account and any other actions taken in connection with the account. Fam will not
        ...
        z 'li',
          ...
          '''
          Fam has not reviewed, and cannot review, all of the material, including computer software,
          posted to the app, and cannot therefore be responsible for that material's content, use or effects. By operating the app, Fam does not
          ...
          terms and conditions, stated or unstated. Fam disclaims any responsibility for any harm resulting from the use by visitors of the app, or from
        ...
        z 'li',
          ...
          through the apps and webpages to which Fam links, and that link to Fam. Fam does not have any control over those external
          apps and webpages, and is not responsible for their contents or their use. By linking to a non-Fam app or webpage, Fam does not represent
          ...
          viruses, worms, Trojan horses, and other harmful or destructive content. Fam disclaims any responsibility for any harm resulting from your use of
          non-Fam apps and webpages.
          '''
        z 'li',
          z 'div.is-bold', 'Copyright Infringement and DMCA Policy.'
          '''
          As Fam asks others to respect its intellectual property rights, it respects the intellectual property rights
          of others. If you believe that material located on or linked to by Fam violates your copyright, you are encouraged to notify Fam in
          accordance with
          '''
          z 'a',
            href: 'https://github.com/claydotio/legal/blob/master/DMCA/Site%20Pages/DMCA%20Takedown%20Notice.md'
            'Fam\'s Digital Millennium Copyright Act Policy'
          '''
          . Fam will respond
          to all such notices, including as required or appropriate by removing the infringing material or disabling all links to the infringing material. Fam     will terminate a visitor's access to and use of the app if, under appropriate circumstances, the visitor is determined to be a repeat infringer of
          the copyrights or other intellectual property rights of Fam or others. In the case of such termination, Fam will have no obligation to provide
          a refund of any amounts previously paid to Fam.
          '''
        z 'li',
          z 'div.is-bold', 'Intellectual Property.'
          '''
          This Agreement does not transfer from Fam to you any Fam or third party intellectual property, and all
          right, title and interest in and to such property will remain (as between the parties) solely with Fam. Fam, the
          Fam logo, and all other trademarks, service marks, graphics and logos used in connection with Fam, or the app are trademarks or
          registered trademarks of Fam or Fam's licensors. Other trademarks, service marks, graphics and logos used in connection with the app
          may be the trademarks of other third parties. Your use of the app grants you no right or license to reproduce or otherwise use any Fam or
          third-party trademarks.
          '''
        z 'li',
          z 'div.is-bold', 'Changes.'
          '''
          Fam reserves the right, at its sole discretion, to modify or replace any part of this Agreement. It is your responsibility
          ...
          constitutes acceptance of those changes. Fam may also, in the future, offer new services and/or features through the app (including, the
        ...
        z 'li',
          ...
          '''
          Fam may terminate your access to all or any part of the app at any time, with or without cause, with or without notice,
          effective immediately. If you wish to terminate this Agreement or your Fam account (if you have one), you may simply discontinue using the
        ...
        z 'li.important',
          ...
          '''
          The app is provided "as is". Fam and its suppliers and licensors hereby disclaim
          ...
          and non-infringement. Neither Fam nor its suppliers and licensors, makes any warranty that the app will be error free or that access
        ...
        z 'li.important',
          ...
          '''In no event will Fam, or its suppliers or licensors, be liable with respect to any subject matter of
          ...
          exceed the fees paid by you to Fam under this agreement during the twelve (12) month period prior to the cause of action. Fam shall have no
        ...
        z 'li',
          ...
          Fam Privacy Policy, with this Agreement and with all applicable laws and regulations (including without limitation any local laws or regulations in
        ...
        z 'li',
          ...
          '''
          You agree to indemnify and hold harmless Fam, its contractors, and its licensors, and their respective directors,
        ...
        z 'li',
          ...
          '''
          This Agreement constitutes the entire agreement between Fam and you concerning the subject matter
          hereof, and they may only be modified by a written amendment signed by an authorized executive of Fam, or by the posting by Fam    of a revised version. Except to the extent applicable law, if any, provides otherwise, this Agreement, any access to or use of the app will
          ...
          to be bound by, its terms and conditions; Fam may assign its rights under this Agreement without condition. This Agreement will be binding
