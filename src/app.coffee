...
Pages =
  ...
  ConnectionLandingPage: require './pages/connection_landing'
  ...
  GroupEarnPage: require './pages/group_earn'
...
module.exports = class App
  ...
  getRoutes: (breakpoint) =>
    ...
    route 'connectionLanding', 'ConnectionLandingPage'
